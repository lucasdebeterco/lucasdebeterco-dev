...
export function Header() {
    return (
        <header id="header" className="fixed z-10 flex min-h-[88px] w-full items-center justify-between bg-background-light bg-opacity-60 px-10 py-6 shadow-overlay backdrop-blur">
