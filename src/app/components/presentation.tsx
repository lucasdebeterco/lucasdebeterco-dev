    ...
    return (
        <section className="flex h-[80vh] flex-col justify-center gap-6">
            <div className="flex flex-col gap-2 font-bold">
                ...
                <h1 className="relative mb-3 w-max text-6xl before:absolute before:bottom-1 before:left-[-4px] before:z-[-1] before:h-3 before:w-full before:-skew-x-[20deg] before:bg-gradient-to-r before:from-indigo-600 before:to-purple-800">
                    Lucas Debeterco.
                </h1>
