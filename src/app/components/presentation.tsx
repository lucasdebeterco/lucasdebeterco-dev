export function Presentation() {
    return (
        <section id="presentation-section" className="flex h-[80vh] flex-col justify-center gap-6">
            <div className="flex flex-col gap-2 font-bold">
                <span id='presentation-span' className="text-xl font-bold text-indigo-500">Hi, my name is</span>
                <h1 id='presentation-name' className="relative mb-3 w-max text-6xl before:absolute before:bottom-1 before:left-[-4px] before:z-[-1] before:h-3 before:w-full before:-skew-x-[34deg] before:bg-gradient-to-r before:from-indigo-600 before:to-purple-800">
                    Lucas Debeterco.
                </h1>
                <h2 className="max-w-[65%] text-3xl" id='presentation-title'>
                    A <strong
